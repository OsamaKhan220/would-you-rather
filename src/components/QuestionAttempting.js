...
import { dispatch_saveQuestionAnswerAction } from "../store/actions/actionDispatchers";
...
const mapDispatchToProps = (dispatch) => ({
  saveAnswer: (authedUser, qid, answer) =>
    dispatch(dispatch_saveQuestionAnswerAction(authedUser, qid, answer)),
});
...
const mapStateToProps = (state, ownProps) => {
  ...
  return {
    ...
    authorName: state.questions[qid]
      ? state.users[state.questions[qid].author].name
      : null,
    authedUser: state.questions[qid] ? state.authedUser : null,
    alreadyAnswered: state.questions[qid]
      ? state.users[state.authedUser].answers.hasOwnProperty(qid)
      : null,
    avatarURL: state.questions[qid]
      ? state.users[state.questions[qid].author].avatarURL
      : null,
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(QuestionAttempting)
);
