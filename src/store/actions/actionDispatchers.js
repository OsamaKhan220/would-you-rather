...
export const dispatch_authedUserAction = (authedUser) =>
  authedUserActionCreator(authedUser);

export const dispatch_userLoggedOutAction = () => userLoggedOutActionCreator();

export const dispatch_initialDataAction = () => (dispatch) =>
  Promise.all([
    API._getUsers(),
    API._getQuestions(),
...
export const dispatch_getUserAction = () => (dispatch) =>
  API._getUsers().then((users) => dispatch(getUserActionCreator(users)));

export const dispatch_getQuestionsAction = () => (dispatch) =>
...
export const dispatch_saveQuestionAction = (question) => {
  return (dispatch) =>
    API._saveQuestion(question).then((question) => {
